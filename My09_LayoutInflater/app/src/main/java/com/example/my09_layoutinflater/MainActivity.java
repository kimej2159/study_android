    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInflate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //시스템에서 LAYOUT_INFLATER_SERVICE를 가져와서
                //인스턴스를 만들어 넣는다
                ...
                btnLinear.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(MainActivity.this, "리니어 버튼이 눌렸습니다", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                btnrelative.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(MainActivity.this, "렐리티브 버튼이 눌렸습니다", Toast.LENGTH_SHORT).show();
                    }
                });
